            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="<?php echo e(route('orders.delivered')); ?>">
                            <div class="sb-nav-link-icon"><i class="fa fa-plus" aria-hidden="true"></i></div>
                            Sold Item List
                        </a>
                        ...
                        <a class="nav-link" href="<?php echo e(route('spinewheel.view')); ?>">
                            <div class="sb-nav-link-icon"><i class="fa fa-plus" aria-hidden="true"></i></div>
                            Spine Wheel Text
                        </a>
                        <a class="nav-link" href="<?php echo e(route('wheel.slice.view')); ?>">
                            <div class="sb-nav-link-icon"><i class="fa fa-plus" aria-hidden="true"></i></div>
                            Spine Wheel Slice Text
                        </a>
                        <a class="nav-link" href="<?php echo e(route('details.create')); ?>">
                            <div class="sb-nav-link-icon"><i class="fa fa-plus" aria-hidden="true"></i></div>
                            Detail's
                        </a>

                        <a class="nav-link" href="<?php echo e(route('company.info.index')); ?>">
                            <div class="sb-nav-link-icon"><i class="fa fa-plus" aria-hidden="true"></i></div>
                            Company Detail's
                        </a>
                        <a class="nav-link" href="<?php echo e(route('popup.message.manage')); ?>">
                            <div class="sb-nav-link-icon"><i class="fa fa-plus" aria-hidden="true"></i></div>
                            PopUp Detail's
                        </a>
