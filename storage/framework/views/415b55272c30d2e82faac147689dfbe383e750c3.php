...
<div class="card">
    ...
    <div class="card-body row">
        ...
        <hr>
      <form action="<?php echo e(route('logo.update', $logos->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>
        <div class="mb-3">
            <label class="form-label">Current Website Logo</label>
            <img src="<?php echo e($logos->logo_url); ?>" alt="" class="logo-img">
