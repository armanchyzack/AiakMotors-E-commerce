    ...
    <div class="row">
        ...
        <div class="col-<?php echo $__env->yieldContent('product'); ?>" style="height: 100vh;">
                    ...
                    <div class="dropdown btn-group-sm profile">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark">
                            <?php if(auth()->guard()->guest()): ?>
                                ...
                                <li><a class="dropdown-item active" href="<?php echo e(route('user.register')); ?>">Register</a></li>
                            <?php else: ?>
            ...
            <div class="col-12 p-1 search">
                <div class="container">
                    <form class="d-flex" action="<?php echo e(route('searchResults')); ?>" method="GET" id="searchForm">
                        <input class="form-control me-2" name="query" id="searchbar" type="search" placeholder="Search" aria-label="Search" autocomplete="off" value="<?php echo e(request()->get('query')); ?>">
            ...
            <div class="container my-5 " id="social">
                ...
                <footer class="text-center text-lg-start social-btn">
                    ...
                    <div>
                        <h5 class="text-white text-center"><?php echo e($comapnyinfo->phone_number); ?></h5>
...
<div id="exit-popup"  class="modal">
    ...
    <div class="modal-content">
        ...
        <p id="text"><?php echo $popup->description; ?></p>
    ...
    if (event.keyCode === 13 || searchQuery.length >= 2) {
        $.ajax({
            url: "<?php echo e(route('search')); ?>", // Make sure this route exists
            method: "GET",
            data: {
                query: searchQuery,
