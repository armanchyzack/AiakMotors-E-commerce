...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="slug" class="form-control" value="<?php echo e($categories->slug); ?>">
        </div>
        <div class="mb-3">
            <label class="form-label">Current Category Image</label>
            <img src="<?php echo e($categories->image_url); ?>" alt="<?php echo e($categories->title); ?>">
        </div>
        <div class="mb-3">
...
<?php echo $__env->make('Backend.Layouts.back_end_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Client Project\CarShop\AiakMotors\resources\views\Backend\Category\edit.blade.php ENDPATH**/ ?>