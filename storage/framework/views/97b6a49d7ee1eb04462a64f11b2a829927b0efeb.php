...
<div class="card">
    ...
    <div class="card-body row">
        <h5 class="card-title col-6">Add a Accessory Product</h5>
        <span class="col-6 text-end"><a href="<?php echo e(route('accessory.all')); ?>" class="btn btn-success btn-sm">All  Accessory</a></span>
        <hr>
      <form action="<?php echo e(route('accessory.store')); ?>" method="POST" enctype="multipart/form-data" class="row">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('Backend.Layouts.back_end_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Client Project\CarShop\AiakMotors\resources\views/Backend/Accessory/add_accessory.blade.php ENDPATH**/ ?>