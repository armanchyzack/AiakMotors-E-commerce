                    ...
                    <div class="card-body">
                        ...
                        <?php if($car->discount_price): ?>
                            <h6 class="text-white mt-1 text-bg-light"><?php echo e($car->discount_price); ?> <span><i
                                        class="fa-solid fa-bangladeshi-taka-sign sm"></i></span></h6>
                        <?php endif; ?>
                        <button class="btn btn-sm allimg gallery-link button" onclick="show('popup-<?php echo e($car->id); ?>')">All
                            Image</button>
                        <div class="d-flex mt-2 buttonn">
                            <a href="<?php echo e(route('item.show',['type' => 'car', 'id' => $car->id])); ?>" class="btn btn-sm">More Deatils</a>
                        </div>
                    </div>
                    <div class="container">
                        ...
                        <div class="popup" id="popup-<?php echo e($car->id); ?>">
                            <div id="<?php echo e($car->id); ?>" class="carousel slide" data-bs-ride="carousel">
                                ...
                                <div class="carousel-indicators">
                                    ...
                                    <?php $__currentLoopData = $car->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button type="button" data-bs-target="#<?php echo e($car->id); ?>"
                                            data-bs-slide-to="<?php echo e($index + 0); ?>"
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <?php $__currentLoopData = $car->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="carousel-item <?php echo e($index === 0 ? 'active' : ''); ?>">
                                            <img src="<?php echo e($img->image_url); ?>" alt="Image <?php echo e($index + 1); ?>" class="d-block"
                                                style="width:100%">
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            ...
                            <a href="#" class="btn btn-sm mt-4"
                                style="border: 1px solid #ffd700; backgorund:inherit; color:#ffd700"
                                onclick="hide('popup-<?php echo e($car->id); ?>')">Close</a>
                        </div>
                    </div>
                </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
