...
<div class="card">
    ...
    <div class="card-body row">
        ...
        <span class="col-6 text-end"><a href="{{ route('accessory.all') }}" class="btn btn-success btn-sm">All  Accessory</a></span>
        <hr>
      <form action="{{ route('accessory.store') }}" method="POST" enctype="multipart/form-data" class="row">
        @csrf
